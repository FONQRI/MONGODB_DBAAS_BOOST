...
// std::string dbaas::database::admin::increase_request(std::string username,
//							 std::string name,
//							 int request_per_day)
//{
//	// reply message
...
bool dbaas::database::admin::m_check_key_database(std::string username,
						  std::string key,
						  std::string &reply,
...
bool dbaas::database::admin::m_check_key(std::string username,
